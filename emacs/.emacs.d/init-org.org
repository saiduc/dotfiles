...
(setq org-capture-templates
      '(
	("p" "Quick Note - Personal" entry (file+headline "~/Documents/Org/Personal/Inbox.org" "Inbox")
	 "** %?" :empty-lines 0)
	("P" "Quick Task - Personal" entry (file+headline "~/Documents/Org/Personal/Inbox.org" "Inbox")
	 "** TODO %?" :empty-lines 0)
	("w" "Quick Note - Work" entry (file+headline "~/Documents/Org/Work/Inbox.org" "Inbox")
	 "** %?" :empty-lines 0)
	("W" "Quick Task - Work" entry (file+headline "~/Documents/Org/Work/Inbox.org" "Inbox")
       "** TODO %?\n%i%a" :empty-lines 0)
	))
#+end_src
