...
Install using: sudo npm install -g pyright
#+begin_src emacs-lisp
...
I use general.el to get some spacemacs-like keybindings
#+begin_src emacs-lisp
(use-package general
  :ensure t
  :defer t)
...
(space-leader
 ...
 "fc" '(:ignore t :which-key "config files")
 "fb" 'helm-bookmarks
 "fo" 'my/list-org-files
 "fd" 'dired
 "ff" 'helm-find-files
 "fs" 'save-buffer
 "fg" 'magit-status
 ...
 "ci" '((lambda () (interactive) (find-file "~/.config/emacs/init.el")) :which-key "init.el")
 "co" '((lambda () (interactive) (find-file "~/.config/emacs/init-org.org")) :which-key "init-org.org")
 "cc" '((lambda () (interactive) (find-file "~/.config/emacs/custom.el")) :which-key "custom.el")
 "cv" '((lambda () (interactive) (find-file "~/.config/nvim/init.vim")) :which-key "init.vim")
 "cf" '((lambda () (interactive) (find-file "~/.config/fish/config.fish")) :which-key "config.fish")
 ...
 "oa" '((lambda () (interactive) (org-agenda nil "n")) :which-key "org-agenda")
 "oc" 'org-capture
 "of" 'my/list-org-files
 ...
 ;; Programming (SPC-l)
(space-leader
  :keymaps '(prog-mode-map tex-mode-map)
  "l" (general-simulate-key "C-l" :which-key "+LSP"))
#+end_src
