...
(use-package company-box
  ...
  :init (setq company-box-doc-enable nil))
#+end_src
...
(use-package org-ref
  :ensure t
  ;; don't defer this since the font-lock doesn't work otherwise
  :init
  ...
  :config
  ;; can choose between fancy helm insert and basic insert
...
(defun my/jupyter-lab ()
  (interactive)
  (async-shell-command "jupyter lab --no-browser")
  (switch-to-buffer-other-window "*Async Shell Command*")
  (sit-for 7)
  (search-backward "http://localhost")
  (set-mark-command ())
  (end-of-line)
  (call-interactively 'kill-ring-save)
  (setq yanked (car kill-ring))
  (when (interactive-p) (message "%s" yanked))
  (xwidget-webkit-browse-url yanked))
#+end_src
