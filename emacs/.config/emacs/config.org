...
(use-package helm-bibtex
  :straight t
  :defer t
  :bind (:map org-mode-map :package org ("C-c ]" . helm-bibtex-with-local-bibliography))
  :init
  ...
  ;; make helm-bibtex use org-cite links
  ...
  :config
  ;; make helm-bibtex default action inserting citation
