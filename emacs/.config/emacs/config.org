...
(setq org-capture-templates
	...
	("pt" "Quick Task" entry (file+olp "~/Dropbox/Org/Inbox.org" "Tasks")
	 "** TODO %?" :kill-buffer t)
	
	("pe" "Quick Event" entry (file+olp "~/Dropbox/Org/Inbox.org" "Events")
	 "** %?\n%^T" :kill-buffer t)

	("pn" "Quick Note" entry (file+olp "~/Dropbox/Org/Inbox.org" "Notes")
	 "** %?" :kill-buffer t)
...
(use-package ein-notebook
  ...
  :bind (:map ein:notebook-mode-map
	      (("M-d" . ein:worksheet-kill-cell-km)
	       ...
	       ("M-u" . ein:worksheet-toggle-cell-type)
