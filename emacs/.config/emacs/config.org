...
(use-package org
  ...
  (org-babel-do-load-languages 
   ...
   '((emacs-lisp . t)
     ;; (ein        . t)
     (python     . t)))
  ;; (add-to-list 'org-structure-template-alist '("j" . "src ein-python"))
  ;; (setq org-babel-default-header-args:ein-python '((:results . "raw drawer")))
  ;; ein is commented as I don't currently use org-mode for jupyter replacement
...
(use-package ox-latex
  ...
  ;; margins for binding
  ;; (setq org-latex-packages-alist '(("a4paper,width=150mm,top=25mm,bottom=25mm,bindingoffset=15mm" "geometry" nil)))

  ;; general margins
  (setq org-latex-packages-alist '(("tmargin=0.85in, bmargin=0.85in, lmargin=0.85in, rmargin=0.85in" "geometry" nil)))


  ;; org table captions are above
...
(setq org-capture-templates
	...
	("pf" "Monthly Finance Review" entry (file+olp+datetree "~/Dropbox/Org/Personal/Finance.org" "Monthly Review Log")
	 "** Monthly Finance Review [0/7]
         - [ ] Check Transactions in Starling, Barclays and Amex
         - [ ] Download Bank statements for Starling and Amex
         - [ ] Import Bank Statements into Homebank
         - [ ] Review Imports and Correct Errors
         - [ ] Download Vanguard statement
         - [ ] Import Vanguard statement into Homebank
         - [ ] Mark TODO as DONE"
