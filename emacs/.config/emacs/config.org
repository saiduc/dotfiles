...
(use-package org
  ...
  (defun my/sync-google-calendars ()
    ...
    (call-process "~/dotfiles/scripts/sync_phd_work_plan" nil 0 nil)
...
(use-package elfeed-protocol
  ...
  (setq elfeed-protocol-newsblur-fetch-tags nil)
...
** EMMS
EMMS is a music player for Emacs
#+begin_src emacs-lisp
(use-package emms
  :straight t
  :defer t
  ...
  :config
  (emms-all)
  (setq emms-player-list '(emms-player-vlc emms-player-ogg123))
  (setq emms-info-functions '(emms-info-native emms-info-ogginfo emms-info-exiftool)))
#+end_src
* Programming
** General
