...
(use-package lsp-mode
  ...
  (setq lsp-signature-posframe-params '(:height 2 :width 60 :min-width 30))
...
Posframe is necesary to show signatures in a popup
#+begin_src emacs-lisp
...
(use-package ein-notebook
  ...
  (custom-set-faces  ;; make background of cells darker and change font colour
   '(ein-codecell-input-area ((t (:foreground "#23242F"))))
   '(ein:codecell-input-area ((t (:extend t :background "#23242F")))))
