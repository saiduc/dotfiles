...
Save history between emacs sesssions
#+begin_src emacs-lisp
...
(use-package org
  ...
  (setq org-agenda-files (apply 'append
				(list
				 (directory-files-recursively "~/Dropbox/Org/University" "\\.org$")
  ...
  (setq org-babel-default-header-args:ein-python '((:results . "output")))
...
** YASnippets
This package provides quick snippet insertion
#+begin_src emacs-lisp
...
(use-package ein-notebook
  ...
  (setq ein:markdown-header-scaling nil) ;; disable different sized headings
