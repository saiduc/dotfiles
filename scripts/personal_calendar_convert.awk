...
BEGIN {
    ...
    author = ENVIRON["AUTHOR"] != "" ? ENVIRON["AUTHOR"] : "Sai Pandian"

    # and to your email address
    emailaddress = ENVIRON["EMAIL"] != "" ? ENVIRON["EMAIL"] : "saipandian97@gmail.com"

    # main title of the Org file
    title = ENVIRON["TITLE"] != "" ? ENVIRON["TITLE"] : "Personal Calendar"

    # calendar/category name for display in org-mode
    calendarname = ENVIRON["CALENDAR"] != "" ? ENVIRON["CALENDAR"] : "Personal GCal"

    # any tags for this calendar (e.g. "WORK" or "PERSONAL")
    filetags = ENVIRON["FILETAGS"] != "" ? ENVIRON["FILETAGS"] : ""
